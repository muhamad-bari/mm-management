              ...
              <div class="widget_list">
                <nav>
                  <div class="nav nav-tabs text-start" id="nav-tab" role="tablist">
                    <button class="nav-link text-start" id="nav-accountpayment-tab" data-bs-toggle="tab" data-bs-target="#nav-accountpayment" type="button" role="tab" aria-controls="nav-accountpayment" aria-selected="true">Account & Payments</button>
                    <button class="nav-link text-start" id="nav-manageother-tab" data-bs-toggle="tab" data-bs-target="#nav-manageother" type="button" role="tab" aria-controls="nav-manageother" aria-selected="false">Manage Orders</button>
                    <button class="nav-link text-start" id="nav-returrefund-tab" data-bs-toggle="tab" data-bs-target="#nav-returrefund" type="button" role="tab" aria-controls="nav-returrefund" aria-selected="false">Returns & Refunds</button>
                    <button class="nav-link text-start" id="nav-covid19-tab" data-bs-toggle="tab" data-bs-target="#nav-covid19" type="button" role="tab" aria-controls="nav-covid19" aria-selected="false">COVID-19</button>
                    <button class="nav-link text-start active" id="nav-other-tab" data-bs-toggle="tab" data-bs-target="#nav-other" type="button" role="tab" aria-controls="nav-other" aria-selected="false">Other</button>
                  </div>
                </nav>
              </div>
            </div>
          ...
          <div class="col-md-9 col-lg-9 col-xl-9 offset-xl-1">
            <div class="terms_condition_grid text-start">
              <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-returrefund" role="tabpanel" aria-labelledby="nav-returrefund-tab">
                  <div class="grids mb90 mb40-md">
                    <h4 class="title">1. Introduction</h4>
                    <p class="mb25 text fz15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus nascetur morbi nisl, mi, in semper metus porttitor non. Augue nunc amet fringilla sit. Fringilla eget arcu sodales sed a, parturient fermentum amet scelerisque. Amet purus urna, dictumst aliquet aliquam natoque non, morbi pretium. Integer amet fermentum nibh viverra mollis consectetur arcu, ultrices dolor. Gravida purus arcu viverra eget. Aliquet tincidunt dignissim aliquam tempor nec id. Habitant suscipit sit semper duis odio amet, at.</p>
                    <p class="text fz15">Massa ultricies a arcu velit eget gravida purus ultrices eget. Orci, fames eu facilisi justo. Lacus netus a at sed justo vel leo leo pellentesque. Nulla ut laoreet luctus cum turpis et amet ac viverra. Vitae neque orci dui eu ac tincidunt. Egestas placerat egestas netus nec velit gravida consectetur laoreet vitae. Velit sed enim habitant habitant non diam. Semper tellus turpis tempus ac leo tempor. Ultricies amet, habitasse adipiscing bibendum consequat amet, sed. Id convallis suspendisse vitae, lacinia mattis cursus montes, dui. Tortor lobortis dignissim eget egestas. Eget enim auctor nunc eget mattis sollicitudin senectus diam. Tincidunt morbi egestas dignissim eget id aliquam. </p>
