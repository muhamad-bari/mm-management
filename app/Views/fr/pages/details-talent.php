        ...
        <div class="col-sm-8 col-lg-10">
          <div class="breadcumb-style1 mb10-xs">
            <div class="breadcumb-list">
              ...
              <a href="<?= base_url($locale . '/details-talent') ?>">Details Talent</a>
            </div>
          </div>
        </div>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  ...
                  <div class="list-content">
                    ...
                    <h6 class="list-title"><a href="<?= base_url($locale . '/details-service') ?>">I will design modern websites in figma or adobe xd</a></h6>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  ...
                  <div class="list-content">
                    ...
                    <h6 class="list-title"><a href="<?= base_url($locale . '/details-service') ?>">I will create modern flat design illustration</a></h6>
                    <div class="review-meta d-flex align-items-center">
                      <i class="fas fa-star fz10 review-color me-2"></i>
                      <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                    </div>
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="listing-style1">
                  ...
                  <div class="list-content">
                    ...
                    <h6 class="list-title line-clamp2"><a href="<?= base_url($locale . '/details-service') ?>">I will build a fully responsive design in HTML,CSS, bootstrap, and javascript</a></h6>
                    <div class="review-meta d-flex align-items-center">
                      <i class="fas fa-star fz10 review-color me-2"></i>
                      <p class="mb-0 body-color fz14"><span class="dark-color me-2">4.82</span>94 reviews</p>
                    </div>
        ...
        <div class="col-lg-4">
          <div class="blog-sidebar ms-lg-auto">
            <div class="price-widget pt25 widget-mt-minus bdrs8">
              ...
              <div class="d-grid">
                <a href="<?= base_url($locale . '/contact') ?>" class="ud-btn btn-thm">Contact Me<i class="fal fa-arrow-right-long"></i></a>
              </div>
            </div>
