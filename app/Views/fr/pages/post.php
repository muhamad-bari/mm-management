        ...
        <div class="roww wow fadeInUp" data-wow-delay="500ms">
          <div class="col-xl-8 offset-xl-2">
            ...
            <div class="col-lg-12 mt40">
              <img src="<?= base_url('') ?>frontend/images/blog/blog-single-2.jpg" alt="" class="bdrs4 post-img-2 w-100">
            </div>
            ...
            <div class="bsp_comments bdrb1 d-block d-sm-flex justify-content-between pt30 pb45 pb30-sm">
              <div class="mbp_first d-flex">
                <div class="flex-shrink-0"> <img src="<?= base_url('') ?>frontend/images/blog/comments-1.png" class="mr-3" alt="comments-1.png"> </div>
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          <div class="col-sm-6 col-xl-3">
            <div class="blog-style1">
              ...
              <div class="blog-content">
                ...
                <h4 class="title mt-1"><a href="<?= base_url('post') ?>">Start an online business and work from home</a></h4>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="blog-style1">
              ...
              <div class="blog-content">
                <a class="date" href="#">December 2, 2022</a>
                <h4 class="title mt-1"><a href="<?= base_url('post') ?>">Front becomes an official Instagram Marketing Partner</a></h4>
                <p class="text mb-0">A complete guide to starting a small business online</p>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-3">
            <div class="blog-style1">
              ...
              <div class="blog-content">
                <a class="date" href="#">December 2, 2022</a>
                <h4 class="title mt-1"><a href="<?= base_url('post') ?>">Engendering a culture of professional development</a></h4>
                <p class="text mb-0">A complete guide to starting a small business online</p>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-xl-3">
            <div class="blog-style1">
              ...
              <div class="blog-content">
                <a class="date" href="#">December 2, 2022</a>
                <h4 class="title mt-1"><a href="<?= base_url('post') ?>">Increasing engagement with Instagram</a></h4>
                <p class="text mb-0">A complete guide to starting a small business online</p>
              </div>
            </div>
          </div>
