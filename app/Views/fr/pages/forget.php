      ...
      <div class="row">
        <div class="col-lg-6 m-auto wow fadeInUp" data-wow-delay="300ms">
          <div class="main-title text-center">
            <h2 class="title"><?= lang('forget.trouble') ?></h2>
            <p class="paragraph"><?= lang('forget.subtrouble') ?></p>
          </div>
        </div>
      </div>
      <div class="row wow fadeInRight" data-wow-delay="300ms">
        <div class="col-xl-6 mx-auto">
          <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
            <div class="mb20">
              <label class="form-label fw600 dark-color"><?= lang('forget.email') ?></label>
              <input type="email" class="form-control" placeholder="<?= lang('forget.email') ?>">
            </div>
            <div class="d-grid mb20">
              <button class="ud-btn btn-thm" type="button"><?= lang('forget.send') ?> <i class="fal fa-arrow-right-long"></i></button>
            </div>
