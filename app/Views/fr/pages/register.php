      ...
      <div class="row">
        <div class="col-lg-6 m-auto wow fadeInUp" data-wow-delay="300ms">
          <div class="main-title text-center">
            <h2 class="title"><?= lang('register.register') ?></h2>
            <p class="paragraph"><?= lang('register.subregister') ?></p>
          </div>
        </div>
      </div>
      <div class="row wow fadeInRight" data-wow-delay="300ms">
        <div class="col-xl-6 mx-auto">
          <div class="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
            <div class="mb30">
              <h4><?= lang('register.lets') ?></h4>
              <p class="text mt20"><?= lang('register.already') ?> <a href="<?= base_url($locale . '/login') ?>" class="text-thm"><?= lang('register.login') ?></a></p>
            </div>
            <div class="mb25">
              <label class="form-label fw500 dark-color"><?= lang('register.display') ?></label>
              <input type="text" class="form-control" placeholder="ali">
            </div>
            <div class="mb25">
              <label class="form-label fw500 dark-color"><?= lang('register.username') ?></label>
              <input type="text" class="form-control" placeholder="alitf">
            </div>
            <div class="mb25">
              <label class="form-label fw500 dark-color"><?= lang('register.email') ?></label>
              <input type="email" class="form-control" placeholder="alitfn58@gmail.com">
            </div>
            <div class="mb15">
              <label class="form-label fw500 dark-color"><?= lang('register.password') ?></label>
              <input type="text" class="form-control" placeholder="*******">
            </div>
            <div class="d-grid mb20">
              <button class="ud-btn btn-thm default-box-shadow2" type="button"><?= lang('register.create') ?> <i class="fal fa-arrow-right-long"></i></button>
            </div>
